...
import javax.swing.*;
import java.sql.*;
class demo12 extends JPanel implements ActionListener
{
Button b1,b2,b3;
int x,y,z;
...
*/	l1=new Label("Name of Applicant:");
	...
	add(l18);
	l19=new Label("Please Fill The Name of Institute:");
	l19.setBounds(30,420,190,20);
	add(l19);
	t1=new TextField();
